		...
		<div class=" w-[90%] shadow">
			...
			<div class="flex justify-center">
				<form class="add-topic-form"
					...
					method="post">
					<div class="flex flex-col justify-center items-center pb-[20px] pt-[20px] lg:w-[100%] md:w-[500px] sm:w-[300px] w-[200px] ">
						<label class="text-orange-500 font-bold text-[25px] pb-[10px]">Manage
							...
							required="required" placeholder="Enter topic..." type="text" name="topicName" />
			...
			<div class="">
				<c:forEach var="topic" items="<%=topics%>">
					<div data-topicid="${topic.getTopicID()}" class="flex justify-center border-[1px] border-gray-100">
						<h2 class="topic-name pl-[10px] font-semibold text-[#2980b9] flex items-center w-[650px] h-[32px]">${topic.getTopicName()}</h2>
						<button class="update-topic-btn mr-[10px]" type="button">
							<svg xmlns="http://www.w3.org/2000/svg" height="20" fill="#2980b9"
