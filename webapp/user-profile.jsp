...
<body data-userprofileid="<%=user.getUserID()%>"
	...
	<div
		...
		<div
			...
			<div class="followers-container px-5 max-h-[200px] overflow-y-scroll">
				<a href="user-profile?userID=" class="flex gap-4 mb-5">
			...
			<button class="view-more-followers-btn text-gray-600">View more</button>
	...
	<button class="view-followers-btn">View followers (Để tạm thôi)</button>
	...
	<div class="viewProfile">
		<div class="profile">
			...
			<div class="stats stats2">
				<span> <i class="fa-regular fa-circle-question"></i> <span><%=user.getTotalQuestions()%></span>
					Questions
				</span> <span class="followers-sum-container"> <i
